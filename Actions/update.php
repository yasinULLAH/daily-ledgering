...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	...
	$date = date("d/m/Y");
	$d = $_POST['detail'];
  $insertSQL = sprintf("update detail set date='$date', name=%s, type=%s, amount=%s, conn_id='$id', detail = '$d' where id = '$idd'",
  ...
  if($result2){header("location:../insert-record.php?msg=SuccessFully Updated Your Data");}
}
ob_flush();
?>
