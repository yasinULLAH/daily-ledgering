...
$query_all = "SELECT * FROM clients where result is not null";
...
<div id="print">
<div id="info"><?php echo $infoMe ?> &nbsp;<font color="#FF0000">All Accounts</font></div>
<br />
<table width="908" style="margin-left:3%" height="46" border="1" cellspacing="0" id="all">
  <tr>
    <th>S:No</th>
    <th>Date</th>
    <th>Name</th>
