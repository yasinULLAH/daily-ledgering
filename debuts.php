...
$query_deput = "select * from clients where result like '%-%' AND result != 0 && result is not null  order by id desc";
$qa = mysql_query("select SUM(result) AS rxz from clients where result like '%-%' AND result != 0");
...
<table width="1054" height="579" cellspacing="0">
  ...
  <tr>
	...
	<?php } ?>
	<font size="+2">Debut Accounts</font> <a href="debuts_all.php">View All Debuts</a><br />
	<table border="0">
	  <tr>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div id="cr">This Total Debut Amount : <b><?php echo $tt; ?></b></div>
    <div id="cr2">Over All Debut Amount : <b><?php echo $r; ?></b></div>
    <table border="0">
  <tr>
    <td><?php if ($pageNum_deput > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_deput=%d%s", $currentPage, 0, $queryString_deput); ?>">First</a>
