...
$query_all = "select * from clients where result like '%-%' AND result != 0 && result is not null  order by id desc";
$all = mysql_query($query_all, $myconn) or die(mysql_error());
$row_all = mysql_fetch_assoc($all);
$totalRows_all = mysql_num_rows($all);
$t = mysql_query("select SUM(result) AS total from clients where result like '%-%' AND result != 0");
...
<div id="print">
<div id="info"><?php echo $infoMe ?> &nbsp;<font color="red">Debut</font> Accounts</div>
<br />
