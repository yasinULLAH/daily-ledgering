...
<table width="1054" height="579" cellspacing="0">
  ...
  <tr>
	...
	<?php }else
	{?>
    <div id="msg">Enter The Account Name Or ID To Delete</div>
	 <?php } ?>
    </p>
    <fieldset>
    <legend>Account Delete Wizard</legend>
      <form id="delete" name="delete" method="get" action="actions/delete_client.php">
...
?>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input type="submit" value="Delete Record" onclick="return confirm('Are You Sure Want To Delete')"/>
      </form>
      </p>
      <br />
